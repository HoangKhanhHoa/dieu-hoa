...
namespace idn.AnPhu.Biz.Persistance.SqlServer
{
    public class Sys_UserProvider : DataAccessBase, ISys_UserProvider
    {
        ...
        public List<Sys_User> Search(string userCode, string fullName, string phoneNo, string email, string sex, string flagActive, string isSysAdmin, int pageIndex, int pageCount, ref int totalItems)
        {
